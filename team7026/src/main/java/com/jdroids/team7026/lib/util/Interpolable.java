...
/**
 * An interface used by an Interpolating Tree as the Value type. Given two end point and an
 * interpolation parameter on [0, 1], it calculates a new Interpolable representing the
 * interpolated value
 * @param <T>
