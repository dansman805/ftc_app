 ...
 * ConstantsBase
 *
 * Base class for storing robot constants. Any value stored in a public static field will be reflected and can be modified externally
 */
public abstract class ConstantsBase {
    ...
    public boolean setConstant(String name, Object value) {
        ...
        for (Field field : declaredFields) {
            if (java.lang.reflect.Modifier.isStatic(field.getModifiers()) && field.getName().equals(name)) {
                try {
                    ...
                    Log.e("Constants", "Could not set field: " + name);
                }
            }
        }
        return success;
