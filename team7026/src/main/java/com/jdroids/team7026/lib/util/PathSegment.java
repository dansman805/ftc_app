...
import com.jdroids.team7026.lib.util.transformations.Translation2d;

/**
 * A PathSegment contains two Translation2d objects, which are the start and end points, and the
 * speed of the robot
 */
